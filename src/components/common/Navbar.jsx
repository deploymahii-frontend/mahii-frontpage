  ...
  useEffect(() => {
    ...
    if (savedLocation) {
      try {
        ...
        setSelectedLocation({ address: savedLocation });
      }
    } else {
        ...
        <div className="flex justify-between items-center h-16 lg:h-18">
          ...
          <div className="hidden lg:block relative" ref={locationRef}>
            <button
              ...
              className="flex items-center justify-between gap-2 px-3 py-2 rounded-xl hover:bg-gray-100/50 dark:hover:bg-gray-800/50 transition group max-w-[250px]"
            >
              <FiMapPin className="text-[#C2185B] text-lg shrink-0" />
              <span className="mx-2 flex-1 text-sm text-gray-700 dark:text-gray-300 truncate">

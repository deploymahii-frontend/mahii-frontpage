  ...
  const contactInfo = [
    {
      icon: MapPin,
      title: "Visit Us",
      details: ["Near KIT's college, Kolhapur , Maharashtra", "India - 416234"],
    },
    {
      icon: Phone,
      title: "Call Us",
            ...
            <div className="space-y-5">
              ...
              <div className="bg-white rounded-xl p-5 shadow-sm">
                ...
                <div className="flex gap-3">
                  ...
                  <a href="https://www.linkedin.com/company/mahii-pvt-ltd/?viewAsMember=true" target="_blank" rel="noopener noreferrer" className="w-10 h-10 bg-gray-100 rounded-full flex items-center justify-center text-gray-600 hover:bg-[#FF6B35] hover:text-white transition">
                    <FaLinkedin size={18} />
                  </a>

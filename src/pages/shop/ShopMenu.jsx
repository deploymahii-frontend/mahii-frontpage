            ...
            >
              ...
              <div className="p-4">
                ...
                <div className="flex gap-2">
                  <button
                    onClick={() => { setEditingProduct(product); setFormData({ ...product, imagePreview: product.image || '' }); setShowModal(true); }}
                ...
                <div className="grid gap-4">
                  <div>
                    ...
                    <div className="flex flex-wrap items-center gap-3">
                      <label className="inline-flex items-center justify-center rounded-lg border border-dashed border-gray-300 bg-gray-50 px-4 py-3 text-sm font-medium text-gray-600 cursor-pointer hover:bg-gray-100">
                        Choose Image
                        <input
                          type="file"
                          accept="image/*"
                    ...
                    <p className="text-xs text-gray-500 mt-2">Upload a dish photo so users see this item in the menu.</p>
                  </div>
